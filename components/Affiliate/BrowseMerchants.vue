<template>
    <div>
        ...
        <div class="flex flex-wrap mt-2">
          <div @click="show(merchant)" class="w-1/3 border border-white bg-black h-32 w-32 flex flex-col justify-center" v-for="merchant in merchants">
          <img class="w-32 h-100 object-cover" :src="merchant.logo_image_url" alt="">
